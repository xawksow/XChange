...
import com.xeiam.xchange.huobi.dto.streaming.dto.DepthDiff;
 ...
 */
public class MarketDepthDiffPayload extends MarketDepthTopDiffPayload implements
		DepthDiff {
	 ...
	 */
	public MarketDepthDiffPayload(String symbolId, Percent percent,
			long version, long versionOld, Update bidInsert, int[] bidDelete,
			Update bidUpdate, Update askInsert, int[] askDelete,
			Update askUpdate) {
		super(symbolId, version, versionOld, bidInsert, bidDelete, bidUpdate,
				askInsert, askDelete, askUpdate);
