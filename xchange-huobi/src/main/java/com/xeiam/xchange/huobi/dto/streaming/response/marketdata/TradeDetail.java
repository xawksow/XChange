...
import com.xeiam.xchange.huobi.dto.streaming.response.marketdata.payload.TradeDetailPayload;
...
public class TradeDetail extends Message<TradeDetailPayload> {
	...
	public TradeDetail(int version, long _id, String msgType, String symbolId,
			long idCur, long idPrev, long timeMax, long timeMin,
