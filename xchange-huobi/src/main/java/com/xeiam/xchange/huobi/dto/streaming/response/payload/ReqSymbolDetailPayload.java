package com.xeiam.xchange.huobi.dto.streaming.response.payload;
...
public class ReqSymbolDetailPayload extends ReqSymbolListPayload {
	 ...
	 */
	public ReqSymbolDetailPayload(String[] symbolId, String[] symbolName,
			String[] cryptoId, String[] cryptoName, String[] exchangeId,
			String[] exchangeName, String[] currencyId, String[] currencyName,
			BigDecimal[] total, BigDecimal[] suply, String[] introduction) {
		super(symbolId, symbolName, cryptoId, cryptoName, exchangeId,
				exchangeName, currencyId, currencyName);
		this.total = total;
		this.suply = suply;
