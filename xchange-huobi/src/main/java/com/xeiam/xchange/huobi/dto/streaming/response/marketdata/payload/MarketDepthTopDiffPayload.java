...
import com.xeiam.xchange.huobi.dto.streaming.response.payload.AbstractPayload;

/**
 * Payload of {@link MarketDepthTopDiff}.
 */
public class MarketDepthTopDiffPayload extends AbstractPayload implements
		DepthDiff {
	 ...
	 */
	public MarketDepthTopDiffPayload(String symbolId, long version,
			long versionOld, Update bidInsert, int[] bidDelete,
