...
public class ReqMarketDepthPayload extends ReqMarketDepthTopPayload implements Depth {
	 ...
	 * @param askAmount 卖单量
	 */
	public ReqMarketDepthPayload(String symbolId, Percent percent, long time,
            long version,

            String bidName, BigDecimal[] bidPrice, BigDecimal[] bidTotal,BigDecimal[] bidAmount,String askName, BigDecimal[] askPrice, BigDecimal[] askTotal,BigDecimal[] askAmount) {
