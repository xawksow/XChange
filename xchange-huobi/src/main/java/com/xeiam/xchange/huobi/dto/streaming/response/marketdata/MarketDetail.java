...
import com.xeiam.xchange.huobi.dto.streaming.response.marketdata.payload.MarketDetailPayload;
...
public class MarketDetail extends Message<MarketDetailPayload> {
	...
	public MarketDetail(int version, long _id, String msgType, String symbolId,
			long idCur, long idPrev, MarketDetailPayload payload) {
