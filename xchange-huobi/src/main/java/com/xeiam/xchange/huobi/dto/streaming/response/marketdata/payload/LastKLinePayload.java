...
public class LastKLinePayload extends AbstractPayload {
	 ...
	 * @param count 成交笔数
	 */
	public LastKLinePayload(long _id, String symbolId, long time,
			Period period, BigDecimal priceOpen, BigDecimal priceHigh,
			BigDecimal priceLow, BigDecimal priceLast, BigDecimal amount,
			BigDecimal volume, int count) {
		super();
		this._id = _id;
