 ...
 * </p>
 * <p>
 * A limit order lets you set a minimum or maximum price before your trade will
 * be treated by the exchange as a {@link MarketOrder}. There is no guarantee
 * that your conditions will be met on the exchange, so your order may not be
 * executed. However, until you become very experienced, almost all orders
 * should be limit orders to protect yourself.
 * </p>
 */
public final class LimitOrder extends Order implements Comparable<LimitOrder> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8279559549678234421L;
	/**
	 * The limit price
	 */
	 ...
	 * @param limitPrice
	 *            In a BID this is the highest acceptable price, in an ASK this
	 *            is the lowest acceptable price
	 */
	...
	public int compareTo(LimitOrder limitOrder) {
		...
		return this.getTimestamp().compareTo(limitOrder.getTimestamp());
	}
	...
	public boolean equals(Object obj) {
		...
		if (this.getTradableAmount() == null ? (other.getTradableAmount() != null) : this.getTradableAmount().compareTo(other.getTradableAmount()) != 0) {
			return false;
		}
		if (!this.getCurrencyPair().toString().equals(other.getCurrencyPair().toString())) {
			return false;
		}
