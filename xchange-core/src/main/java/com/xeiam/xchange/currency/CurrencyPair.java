...
public class CurrencyPair implements Serializable, Comparable<CurrencyPair> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8013997589291220300L;
	 ...
	 *
	 * @param baseSymbol
	 *            The base symbol is what you're wanting to buy/sell
	 * @param counterSymbol
	 *            The counter symbol is what currency you want to use to
